...
// Uses Google Cloud Storage with credentials from environment variables or default credentials
    ...
    if (!dir) {
      throw new Error(
        "PRIVATE_OBJECT_DIR not set. Create a Google Cloud Storage bucket " +
          "and set PRIVATE_OBJECT_DIR env var to the bucket path (e.g., /bucket-name)."
      );
    }
    return dir;
  }
...
async function signObjectURL({
  ...
  // Map HTTP methods to Google Cloud Storage signed URL actions
